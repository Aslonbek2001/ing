...
from menus.serializers.scientific_direction_serializers import (
    ScientificDirectionListSerializer,
    ScientificDirectionSerializer,
)


@extend_schema(
    tags=["Scientific Direction"],
...
class ScientificDirectionListCreateAPIView(generics.ListCreateAPIView):
    queryset = Page.objects.filter(type="scientific_direction").order_by("position")
    ...
    def get_serializer_class(self):
        ...
        return ScientificDirectionSerializer

    def perform_create(self, serializer):
        serializer.save(type="scientific_direction")
...
class ScientificDirectionDetailAPIView(generics.RetrieveUpdateDestroyAPIView):
    serializer_class = ScientificDirectionSerializer
    permission_classes = [IsAuthenticatedOrReadOnly]
    lookup_field = "lookup"
